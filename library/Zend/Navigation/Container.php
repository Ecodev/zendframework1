...
abstract class Zend_Navigation_Container implements RecursiveIterator, Countable
{
     ...
     *
     * @param  array|Zend_Config|Zend_Navigation_Page $page  page to add
     *
     ...
     *
     * @param  Zend_Config|Zend_Navigation_Container|Zend_Navigation_Page[]  $pages  pages to add
     *
     * @return Zend_Navigation_Container                    fluent interface,
     *                                                      returns self
     */
     ...
     *
     * @param  int|Zend_Navigation_Page $page      page to remove, either a page
    ...
    public function removePage($page, $recursive = false)
    {
        ...
        if (isset($this->_pages[$hash])) {
            unset($this->_pages[$hash], $this->_index[$hash]);
     ...
     *
     * @return null|Zend_Navigation_Page  matching page or null
     */
