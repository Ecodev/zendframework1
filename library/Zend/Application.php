...
class Zend_Application
{
     ...
     * @param  array|string|Zend_Config $options String path to configuration file, or array/Zend_Config of configuration options
     ...
     *
     * @param  null|array|string $resource
     *
     * @return Zend_Application
     */
