...
class Zend_View_Helper_Navigation_Links extends Zend_View_Helper_Navigation_HelperAbstract
{
     ...
     *
     * @return null|array|Zend_Navigaiton_Page  page(s), or null if not found
     */
     ...
     * @param  string              $type        link type, e.g. 'start', 'next'
     *
     * @return null|array|Zend_Navigation_Page  page(s), or null if not found
     */
     ...
     *
     * @return null|array                  array of pages, or null if not found
     */
     ...
     *
     * @return null|Zend_Navigation_Page   page or null
     */
     ...
     * @param  Zend_Navigation_Page $page  page to find relation for
     *
     * @return null|Zend_Navigation_Page   page(s) or null
     */
     ...
     * @param  Zend_Navigation_Page $page       page to find relation for
     *
     * @return null|array|Zend_Navigation_Page  page(s) or null
     */
     ...
     *
     * @return null|array|Zend_Navigation_Page  empty if unable to convert
     */
    protected function _convertToPages($mixed, $recursive = true)
    {
        if (is_object($mixed)) {
            ...
            if ($mixed instanceof Zend_Navigation_Container) {
            ...
            if ($mixed instanceof Zend_Config) {
