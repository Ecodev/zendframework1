...
class Zend_View_Helper_Navigation_Menu extends Zend_View_Helper_Navigation_HelperAbstract
{
     ...
     * rendering.
     *
     * @param  null|string  $ulId                Unique identifier (id) to set
     *
     * @return Zend_View_Helper_Navigation_Menu  fluent interface, returns self
     */
     ...
     * rendering.
     *
     * @return null|string  Unique identifier (id); Default is 'null'
     */
     ...
     *
     * @param  array|string $partial             partial view script or null. If
     ...
     * @param  null|int                  $minDepth      minimum depth
     * @param  null|int                  $maxDepth      maximum depth
     * @param  null|string               $ulId          unique identifier (id)
     *                                                  for first UL
     * @param  bool                      $addPageClassToLi  adds CSS class from
     *                                                      page to li element
     * @param  null|string               $activeClass       CSS class for active
     *                                                      element
     ...
     *                                               the helper.
     * @param  null|string               $ulClass    [optional] CSS class to
     *                                               use for UL element. Default
     *                                               is to use the value from
     *                                               {@link getUlClass()}.
     * @param  int|string                $indent     [optional] indentation as
     *                                               a string or number of
     *                                               spaces. Default is to use
     *                                               the value retrieved from
     *                                               {@link getIndent()}.
     * @param  null|string               $ulId       [optional] Unique identifier
     *                                               (id) use for UL element
     * @param  bool                      $addPageClassToLi  adds CSS class from
     *                                                      page to li element
     * @param  int|string                $innerIndent   [optional] inner
     ...
     * @param  array|string             $partial     [optional] partial view
