...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
     ...
     */
    private bool $_lfiProtectionOn = true;

    /**
     * Plugin loaders.
     */
    private array $_loaders = array();

    /**
     * Plugin types.
     */
    private array $_loaderTypes = array('filter', 'helper');
     ...
     *
     * @param array|string the directory (-ies) to add
     * @param mixed $path
     *
     * @return Zend_View_Abstract
     */
     ...
     *
     * @param array|string the directory (-ies) to set as the path
     * @param mixed $path
     *
     * @return Zend_View_Abstract
     */
     ...
     *
     * @param array|string $path the directory (-ies) to set as the path
     ...
     * @param  string $name
     *
     * @return false|string False on failure, path on success
     */
     ...
     *
     * @param  object|Zend_View_Helper_Abstract $helper
     * @param  string $name
     *
     * @return Zend_View_Abstract
     */
     ...
     *
     * @param array|string one or more filters to add
     * @param mixed $name
     *
     * @return Zend_View_Abstract
     */
     ...
     *
     * @param array|string one or more filters to set
     * @param mixed $name
     *
     * @return Zend_View_Abstract
     */
     ...
     * @see    __set()
     *
     * @param  array|string the assignment strategy to use
     ...
     * @param array|string $path the path specification
