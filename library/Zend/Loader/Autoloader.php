...
class Zend_Loader_Autoloader
{
     ...
     */
    protected $_defaultAutoloader = [\Zend_Loader::class, 'loadClass'];
     ...
     *
     * @param  array|string $callback PHP callback
     */
     ...
     *
     * @return array|string PHP Callback
     */
     ...
     *
     * @param  array|object|string $callback PHP callback or Zend_Loader_Autoloader_Interface implementation
     * @param  array|string $namespace Specific namespace(s) under which to register callback
     *
     * @return Zend_Loader_Autoloader
     */
     ...
     *
     * @param  array|object|string $callback PHP callback or Zend_Loader_Autoloader_Interface implementation
     * @param  null|array|string $namespace Specific namespace(s) from which to remove autoloader
     *
     * @return Zend_Loader_Autoloader
     */
