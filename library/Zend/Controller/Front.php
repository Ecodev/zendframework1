...
class Zend_Controller_Front
{
     ...
     *
     * @param array|string $controllerDirectory Path to Zend_Controller_Action
     ...
     *
     * @param array|string $directory Path to Zend_Controller_Action controller
     ...
     * each.
     *
     * @param null|array|string single key or array of keys for params to clear
     ...
     * @param  string $class
     *
     * @return array|false|Zend_Controller_Plugin_Abstract
     */
