...
class Zend_Locale
{
     ...
     */
    private static array $_localeAliases = [
        'az_AZ' => 'az_Latn_AZ',
        'bs_BA' => 'bs_Latn_BA',
        'ha_GH' => 'ha_Latn_GH',
        'ha_NE' => 'ha_Latn_NE',
     ...
     * Class wide Locale Constants.
     */
    private static array $_territoryData = [
        'AD' => 'ca_AD',
        'AE' => 'ar_AE',
        'AF' => 'fa_AF',
        'AG' => 'en_AG',
     ...
     *
     * @return false|string - Regionstring
     */
     ...
     *
     * @return null|string Locale string or null when no locale has been found
     */
    ...
    public static function getLocaleList()
    {
        ...
        unset($list['root'], $list['auto'], $list['browser'], $list['environment']);
