...
abstract class Zend_File_Transfer_Adapter_Abstract
{
    ...
    public function addPrefixPaths(array $spec)
    {
        ...
        foreach ($spec as $type => $paths) {
            if (is_numeric($type) && is_array($paths)) {
                $type = null;
                if (isset($paths['prefix'], $paths['path'])) {
                    if (isset($paths['type'])) {
                        $type = $paths['type'];
                    }
     ...
     *
     * @param  array|string $validator           Type of validator to add
     * @param  bool      $breakChainOnFailure If the validation chain should stop an failure
     * @param  array|string $options             Options to set for the validator
     * @param  array|string $files               Files to limit this validator to
     *
     ...
     *
     * @param  array|string $files (Optional) Returns the validator for this files
     *
     ...
     *
     * @param  array|string $files (Optional) Files to check
     *
     ...
     *
     * @param  array|string $files (Optional) Returns the filter for this files
     *
     ...
     *
     * @param  array|string $file      File to add
     * @param  array|string $validator Validators to use for this file, must be set before
     * @param  array|string $filter    Filters to use for this file, must be set before
     *
     * @return Zend_File_Transfer_Adapter_Abstract
     */
     ...
     *
     * @param  array|string $type Type of files to add
     * @param  array|string $validator Validators to use for this file, must be set before
     * @param  array|string $filter    Filters to use for this file, must be set before
     *
     * @return Zend_File_Transfer_Adapter_Abstract
     ...
     * @param  array|string $files       Files to set the new destination for
     *
     ...
     * @param  array|string $files Files to return the hash for
     *
     * @return array|string Hashstring
     */
     ...
     *
     * @param array|string $files Files to get the filesize from
     *
     * @return array|string Filesize
     */
     ...
     *
     * @param array|string $files Files to get the mimetype from
     *
     ...
     *
     * @param  array|string $files       (Optional) Files to return
