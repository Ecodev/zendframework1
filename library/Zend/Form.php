...
class Zend_Form implements Iterator, Countable, Zend_Validate_Interface
{
     ...
     *
     * @param  null|array $elements Specific elements to decorate or exclude from decoration
     ...
     * @param  string $name
     *
     * @return null|Zend_Form|Zend_Form_Element
     */
    ...
    public function current(): mixed
    {
        ...
        if (isset($this->_subForms[$key])) {
            return $this->getSubForm($key);
        }
        if (isset($this->_displayGroups[$key])) {
