...
class Zend_Locale_FormatTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testToNumber()
    {
        ...
        $this->assertEquals('1.234.567,12345',   Zend_Locale_Format::toNumber(1_234_567.12345,  $options));
        $this->assertEquals('1٬234٬567٫12345',   Zend_Locale_Format::toNumber(1_234_567.12345,  ['locale' => 'ar_QA']));
        $this->assertEquals('‏-1٬234٬567٫12345',  Zend_Locale_Format::toNumber(-1_234_567.12345,  ['locale' => 'ar_QA']));
        $this->assertEquals('12,34,567.12345',   Zend_Locale_Format::toNumber(1_234_567.12345,  ['locale' => 'dz_BT']));
        $this->assertEquals('-1.234.567,12345',  Zend_Locale_Format::toNumber(-1_234_567.12345,  ['locale' => 'mk_MK']));
    ...
    public function testToFloat()
    {
        ...
        $this->assertEquals('1٬234٬567٫12345',  Zend_Locale_Format::toFloat(1_234_567.12345, $options));
        $this->assertEquals('‏-1٬234٬567٫12345', Zend_Locale_Format::toFloat(-1_234_567.12345, $options));
        $this->assertEquals('12,34,567.12345',  Zend_Locale_Format::toFloat(1_234_567.12345, ['locale' => 'dz_BT']));
        $this->assertEquals('-1.234.567,12345', Zend_Locale_Format::toFloat(-1_234_567.12345, ['locale' => 'mk_MK']));
    ...
    public function testtoInteger()
    {
        ...
        $this->assertEquals('1.234.567',  Zend_Locale_Format::toInteger(1_234_567.12345,   $options));
        $this->assertEquals('1٬234٬567',  Zend_Locale_Format::toInteger(1_234_567.12345,   ['locale' => 'ar_QA']));
        $this->assertEquals('‏-1٬234٬567', Zend_Locale_Format::toInteger(-1_234_567.12345,   ['locale' => 'ar_QA']));
        $this->assertEquals('12,34,567',  Zend_Locale_Format::toInteger(1_234_567.12345,   ['locale' => 'dz_BT']));
        $this->assertEquals('-1.234.567', Zend_Locale_Format::toInteger(-1_234_567.12345,   ['locale' => 'mk_MK']));
    ...
    public function testToNumberFormat()
    {
        ...
        $this->assertEquals('-1.234.567,12345',   Zend_Locale_Format::toNumber(-1_234_567.12345,   $options));
        $this->assertEquals('1.234.567,12345',   Zend_Locale_Format::toNumber(1_234_567.12345,   $options));
        $this->assertEquals('1234567',         Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '##0',      'locale' => 'de_AT']));
        $this->assertEquals('1.23.45.67',         Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '#,#0',     'locale' => 'de_AT']));
        $this->assertEquals('1234567,12',      Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '##0.00',   'locale' => 'de_AT']));
        $this->assertEquals('1234567,12345',   Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '##0.###',  'locale' => 'de_AT']));
        $this->assertEquals('1.23.45.67',         Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '#,#0',     'locale' => 'de_AT']));
        $this->assertEquals('12.34.567',         Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '#,##,##0', 'locale' => 'de_AT']));
        $this->assertEquals('1.234.567,12',      Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '#,##0.00', 'locale' => 'de_AT']));
        $this->assertEquals('1.23.45.67,12',      Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '#,#0.00',  'locale' => 'de_AT']));
        $this->assertEquals('1234567-',        Zend_Locale_Format::toNumber(-1_234_567.12345,   ['number_format' => '##0;##0-', 'locale' => 'de_AT']));
        $this->assertEquals('1234567',         Zend_Locale_Format::toNumber(1_234_567.12345,   ['number_format' => '##0;##0-', 'locale' => 'de_AT']));
        $this->assertEquals('1.234.567,00',      Zend_Locale_Format::toNumber(1_234_567,         ['number_format' => '#,##0.00', 'locale' => 'de_AT']));
        $this->assertEquals('1.234.567,12',      Zend_Locale_Format::toNumber(1_234_567.123,     ['precision' => 2,              'locale' => 'de_AT']));
        $this->assertEquals('1234567,12-',     Zend_Locale_Format::toNumber(-1_234_567.123,     ['number_format' => '#0.00-',   'locale' => 'de_AT']));
